  ...
  describe "#authenticate!" do
    ...
    context "with missing Authorization header" do
      it "raises MissingCredentials error" do
        ...
        expect { service.authenticate!(request) }.to raise_error(Strata::ApiAuthenticator::MissingCredentials)
      end
    end
    ...
    context "with invalid signature" do
      it "raises InvalidSignature error" do
        ...
        expect { service.authenticate!(request) }.to raise_error(Strata::ApiAuthenticator::InvalidSignature)
      end
    end
