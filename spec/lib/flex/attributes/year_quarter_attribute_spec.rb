...
RSpec.describe Strata::Attributes::YearQuarterAttribute do
  ...
  describe "range: true" do
    ...
    let(:range) { Strata::YearQuarterRange.new(start: start_value, end: end_value) }

    it "allows setting a ValueRange object" do
      object.base_period = range

      expect(object.base_period).to eq(Strata::YearQuarterRange.new(start: start_value, end: end_value))
    ...
    it "persists and loads year_quarter_range object correctly" do
      ...
      range = Strata::YearQuarterRange.new(start: start_value, end: end_value)
      object.base_period = range
      object.save!
