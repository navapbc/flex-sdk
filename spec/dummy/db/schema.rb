...
ActiveRecord::Schema[8.0].define(version: 2026_05_06_001000) do
  ...
  create_table "test_records", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.bigserial "user_facing_id_sequence", null: false
    t.bigserial "claim_user_facing_id_sequence", null: false
