...
RSpec.describe Strata::US::ListComponent, type: :component do
  ...
  describe "nested lists" do
    it "supports nesting by rendering a nested ListComponent inside an item" do
      render_inline(described_class.new) do |outer|
        outer.with_item do
          # An item's block content can include arbitrary markup, including a
          # nested list rendered via the same component.
          "Parent item"
        end
      end
