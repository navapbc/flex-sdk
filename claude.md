...
3. **Write RSpec tests** — comprehensive coverage including edge cases; **present to user and wait for approval before writing any implementation**
...
- Use Pundit policy objects for authorization
